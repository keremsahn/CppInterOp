...
CXInterpreterLanguage clang_Interpreter_getLanguage(CXInterpreter I) {
  return (CXInterpreterLanguage)Cpp::GetLanguage(getInterpreter(I));
}

CXInterpreterLanguageStandard clang_Interpreter_getLanguageStandard(CXInterpreter I) {
  return (CXInterpreterLanguageStandard)Cpp::GetLanguageStandard(getInterpreter(I));
}
